...
class Plant:
    ...
    def to_json(self):
        return {
            "plant": self._get_name_from_id(),
            "goldWorth": self.goldWorth,
            "waterNeeded": self.waterNeeded
        }
...
class Tile:
    ...
    def to_json(self):
        return {
            "x": self.x,
            "y": self.y,
            "bIsPlanted": self.bIsPlanted,
            "bIsSpecial": self.bIsSpecial,
            "plantDTO": self.plantDTO.to_json()
        }
...
class Player:
    ...
    def to_json(self):
        return {
            "pos": f"{self.tiles[0].x}_{8 - self.tiles[0].y}",
            "points": self.points,
            "gold": self.gold,
            "fertilizerActive": self.fertilizerActive
        }
